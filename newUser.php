            ...
            <div id='secondBox'>
                <div id='rightBox'>
                    ...
                    <ul id='user_list'>
                        ...
                        <!--Parte visível-->
                        <li id='listTwo'>
                            <img id="profile-icon" src="https://occ-0-933-420.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABRZTyekrojJuCDNoX1H3L2x-2xf7fN6zW6dCk7VlJpe4gFmpM6otBAq5qo7-4lXJdZjJ77SoTFH8x_dwWM4VZUEQdKcSCzTFSYJ-.png?r=3fc" alt="perfil"/>
                        ...
                        <ul id='subListTwo'>
                            ...
                            <li class="listTwo__li">
                                <a href='./usuario.php' target="_self">
                                    <img id="profile-icon" src='https://occ-0-933-420.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABRC8mzIBBNKTufxcrantuy6xGn74_7mpSeJCy1r5NRrl81zQePQ2bzClJfamIftPM-GJq9He6jbuCc0UGYeCXY_ngQNJUyM.png?r=3fc' alt="perfil"/>Sol
                                </a>
                            </li>
                            <li class="listTwo__li">
                                <a href='./userOne.php' target="_self">
