...
<head>
    ...
    <link href='css/stylesCrianca.css' rel='stylesheet'/>
</head>
<body>
    ...
    <header> 
        ...
        <div id='video'>
            ...
            <video id='tagVideo' controls autoplay muted>
                ...
                <source src="arquivos/theCupheadShow.mp4"/>
        ...
        <nav class='mainNavigation'>
            ...
            <div id='secondBox'>
                <div id='rightBox'>
                    ...
                    <div id='backButtonChild'>

                        <a href='./usuario.php'>
                            <img src='https://occ-0-933-420.1.nflxso.net/dnm/api/v6/vN7bi_My87NPKvsBoib006Llxzg/AAAABRt4NpsGm7sIHiYKdr7VmHetkMrYn1RzUTYJCT2m2e1gls25nPLMmuXkYiFvaHkpOyGiTT8L0DnCrJWzgvU3VlR0B1VIYmHWYmgjfQ_Fr1HyCYIA6RmGub3PTxZcKtIdt4Dw3ShZ4ZzXJA.png?r=080' alt='children'/>
                        </a>
        ...
        <div id='seriesOfTheMoment'>
            ...
            <div id='internalSeries'>
                ...
                <h1>
                    <img title='cuphead' id='title' src='https://occ-0-5308-3851.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABXVE5aZiIwGdXFbj8CPG83v269WfVwrklHVsqZsYD76HnO8H7EPYILFy8I0HmWSzYsL4J-efx8O6ROZ7u7W9c1_B6CqHRmepDB0SvX963RziyhoslGRRKYyCIW0TwVIlWiwnXtpohxDEyy59zdT9kwuP6JJPl_nLMb0uALzHAM5YnfeEVuwghA.webp?r=cf6' alt="cuphead"/>
                </h1>
                ...
                <p>Acompanhe as desventuras do impulsivo Xicrinho e seu ingênuo</br>
                    irmão Caneco nesta série de animação baseada no famoso</br> videogame.</p>
    ...
    <main>
        <section class="standardSeriesBox">
            ...
            <div class="scroll">
                ...
                <!--  Parte 1-->
                <img class='imgSerie inicioMortePCarona' alt="A morte pede carona" src="https://occ-0-933-420.1.nflxso.net/dnm/api/v6/rkETp35xJVj-6WaffQsS77awykM/AAAABazqukAAmBEEHYLTXblvO2USIEdMjpoEY9oz1jHEaLB_dbzidie3ZsUq7ugzUUPyJFMWc66dxAcJfVwzwwh22IfaKPFiS437k5BC6ZlVCBMVoEe7XVb17A9PAtLXq9RgYY0wVcUJ2LV2R1zAtg7_clVtdFRqb0MUGo3OBcGJDadDDYts4ZlqyKiNDYWG5JOWRzToL-jef1aUFPETgYVjdkd9f_zMYGtfEyfcVSIEf-gsinpZQwvPJhqbdqIGMldWOvdHgB3vcN2dHXIQ-wbgbfYBl6sPfQDSkUMv63y8LiLX0bFb5YSpmfSvVh4_A6zPKMOxxdC22jwx_3o.webp?r=c4b">
